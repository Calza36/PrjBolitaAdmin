...
abstract class $LimitedCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String>? numbers, List<String>? parlets});
}
...
class _$_Limited implements _Limited {
  const _$_Limited({final List<String>? numbers, final List<String>? parlets})
      : _numbers = numbers,
        _parlets = parlets;
  ...
  @override
  String toString() {
    return 'Limited(numbers: $numbers, parlets: $parlets)';
  }
...
abstract class _Limited implements Limited {
  const factory _Limited(
      {final List<String>? numbers, final List<String>? parlets}) = _$_Limited;
