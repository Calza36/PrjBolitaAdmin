...
class PlayerFootCollectorSmallView extends StatefulWidget {
  ...
  @override
  State<PlayerFootCollectorSmallView> createState() =>
      _PlayerFootCollectorSmallViewState();
}

class _PlayerFootCollectorSmallViewState
    extends State<PlayerFootCollectorSmallView> {
  @override
